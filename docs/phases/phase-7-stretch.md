...
- [ ] Apple OAuth / Magic Link email login
- [ ] More locales beyond en/ua
- [ ] Shareable image generation (OG card image per reading)
- [ ] Reading mood / theme variations (love, career, general)
